export default {
  ...
  share: '分享',
  shareDisclaimer: '本回答由 AI 生成，仅供参考，请仔细甄别',
  shareImageCaptureFailed: '截图失败，请重试',
  shareImageFailed: '分享失败，请重试',
  shareImageGenerated: '分享图已生成',
  shareImageGeneratedDesc: '选择要执行的操作',
  shareImageSaveFailed: '保存失败，请重试',
  shareImageSaveSuccess: '图片已保存到相册',
  shareImageTitle: '分享聊天记录',
  shareMessages: '分享 {{count}} 条消息',
  shareNotAvailable: '您的设备不支持分享功能',
  shareWatermark: '由 {{app}} 生成',
  stop: '停止',
  thinking: '思考中...',
  upload: {
    actions: {
